    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MfaVerifyRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MfaVerifyRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
