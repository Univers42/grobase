    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "StorageCreateBucket200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "StorageCreateBucket200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
