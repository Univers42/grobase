...
step "0/2 preconditions — postgres + kong up, anon key in .env"
...
step "1/2 invariant — anon/authenticated privileges only on RLS-enabled tables"
...
step "2/2 live — the anon key through Kong cannot read or write schema_registry"
...
printf '\033[0;32m[M200] PASS — no RLS-less public table is reachable with the public API key\033[0m\n'
