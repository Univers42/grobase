...
ENTERPRISE_BATTERY=(
  ...
  m189                  # preflight-production refuses dev credentials, never prints a value
  m190                  # prod/cloud overlays render every hardening value on the right service
  m191                  # VAULT_DROP_PRIVILEGES_ENABLED: vault runs as uid != 0; unset keeps HEAD root
