...
TC_IMG="m133-tc-$$:scratch"
AR_IMG="m133-ar-$$:scratch"
NET="m133net-$$"
PG="m133-pg-$$"
TC="m133-tc-$$"
AR="m133-ar-$$"
PORT_TC="${M133_PORT_TC:-18937}"
PORT_AR="${M133_PORT_AR:-18938}"
PGPW="postgres"
...
emit_gate_log() { (
  ...
  log_event GATE --gate "m133=PASS" --outcome pass \
    ...
    --ref "scripts/verify/m133-cross-tenant-safety.sh" >/dev/null 2>&1
  exit 0
) || true; }
emit_gate_log
