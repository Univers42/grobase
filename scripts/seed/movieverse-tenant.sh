...
promote_moderator() {
  [ -n "$SVC" ] || {
    warn "no service key — skipping moderator promote"
    return 0
  }
...
M_MATRIX='603'
P_MATRIX='/f89U3ADr1oiB1s9GkdPOEpXUk5H.jpg'
M_INCEP='27205'
P_INCEP='/oYuLEt3zVCKq57qu2F8dT7NIa6f.jpg'
M_INTER='157336'
P_INTER='/gEU2QniE6E77NI6lCU6MxlNBvIx.jpg'
M_DARK='155'
P_DARK='/qJ2tW6WMUDux911r6m7haRef0WH.jpg'

declare -a EMAILS=() USERNAMES=()
seed_user() { # username email is_mod likes…
  local username="$1" email="$2" mod="$3"
  shift 3
