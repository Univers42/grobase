...
<head>
    ...
    <title>403 — Forbidden | Camagru</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="min-h-screen bg-[#fafafa] text-gray-800 flex items-center justify-center">
    <div class="text-center px-6">
        <div class="text-8xl font-bold text-gray-300 mb-4">403</div>
        <h1 class="text-2xl font-bold text-gray-800 mb-2">Access Denied</h1>
        <p class="text-gray-500 mb-8 max-w-md">You don't have permission to access this page.</p>
