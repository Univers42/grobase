...
| **Cost per tenant (modeled)** | nano ~$2.5/mo · essential ~$13 · pro ~$21 (<$1 amortized) | *na* (per-project + usage + MAU, not per-tenant) | [`cost-analysis.md`](../cost-and-tiers/cost-analysis.md) §3(A) (modeled, formula stated) | — (model, not a bench) |
