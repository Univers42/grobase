...
The underlying findings live in [`../security-audit.md`](../security/security-audit.md) (HIGH/MED/LOW) and
[`../security-audit-asvs.md`](../security/security-audit-asvs.md) (ASVS + open residuals); both feed
...
- [`../security-audit.md`](../security/security-audit.md) · [`../security-audit-asvs.md`](../security/security-audit-asvs.md) — the findings + residuals
