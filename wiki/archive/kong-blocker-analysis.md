...
| Document | Purpose |
|----------|---------|
| [Kong Gateway Configuration](../guides/kong-gateway-configuration.md) | How to add and manage routes |
| [Kong + Database Auth Integration](../guides/kong-database-authentication-integration.md) | End-to-end auth flow through the gateway |
| [Project Status](./project-status-baas-integration-blockers.md) | Current state and next priorities |
| [README.md](../dossier/osionos-dossier-projet.md) | Full project overview |
