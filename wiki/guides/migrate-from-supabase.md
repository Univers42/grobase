...
> [`competitive-matrix.md`](../competitive/competitive-matrix.md). Don't migrate a feature you
...
[`competitive-matrix.md`](../competitive/competitive-matrix.md) for exact status before relying
...
(or never). See [`03-control-plane.md`](../architecture/03-control-plane.md) for the
provisioning model and [`grobase-vs-supabase-offer.md`](../competitive/grobase-vs-supabase-offer.md)
...
- [ ] Verify each feature you depend on is at parity in
      [`competitive-matrix.md`](../competitive/competitive-matrix.md) before cutover.
