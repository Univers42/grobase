...
- **Companions:** [`cost-analysis.md`](./cost-analysis.md) (the older Fly-only narrative — superseded
  ...
  reconciles against), [`nano-vs-pocketbase.md`](../competitive/nano-vs-pocketbase.md),
  [`scale-slo.md`](../operations/scale-slo.md) (the density evidence behind §2).
...
This is **why** it works (and the cited evidence in [`scale-slo.md`](../operations/scale-slo.md) §Evidence-B,
