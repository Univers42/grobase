...
The plan to take the BaaS from "an excellent chassis with the engine half-built" ([../06-product-assessment.md](../architecture/06-product-assessment.md)) to the product in the vision: **engine-agnostic, all operations not just CRUD, OLAP *or* OLTP as a switchable runtime context.**
